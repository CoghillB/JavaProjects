...
public class CSAirlines {
   public static void main(String[] args) {
      ...
      International i1 = new International("Vancouver", "Las Vegas", new Time(17,0), new Time(2,45), null, 15.00, "United States");
      International i2 = new International("Vancouver", "Paris", new Time(20,50), new Time(11,30), null, 25.00, "France");
      // International i3 = new International("Saskatoon", "London", new Time(12,30), new Time(14,48), "Delayed", 250.00, "England");
